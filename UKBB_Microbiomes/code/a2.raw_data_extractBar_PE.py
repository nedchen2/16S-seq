...
Command2 = "extract_barcodes.py" +  " --input_type barcode_in_label " + " -f " + inputDirectory + "/" + R1 + " -r " + inputDirectory + "/" + R2 + " --bc1_len 14 " + " --bc2_len 14"  + " -o " + outputDirectory + "/" # some of the qrgument here could be edit in other experiments
Command3 = " gzip -r " + outputDirectory #rename and zip
Command4 = "cp " + inputDirectory + "/" + R1 + " " + outputDirectory + "/forward.fastq.gz" + " && " + "cp " + inputDirectory + "/" + R2 + " " +  outputDirectory + "/reverse.fastq.gz" 
# run 
